...
import { LayoutDashboard, ShieldCheck, CheckCircle, Users, Settings, Download, GraduationCap, CalendarRange } from 'lucide-react';
  ...
  const tabs = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'term-closing', label: 'Term Closing', icon: CalendarRange },
