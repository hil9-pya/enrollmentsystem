...
export default function AdvisingQueue({ students, initialFilter, onViewDetails }) {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50">
      <div className="p-8 pb-4 space-y-4 bg-white border-b border-slate-200/80 shadow-sm">
        <div>
          <h2 className="text-xl font-extrabold text-univ-navy">Advising Queue</h2>
          <p className="text-xs text-slate-500 mt-1 font-medium">Manage and review student curriculum evaluations.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2">
          <div className="relative w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-xs bg-white border border-slate-200 rounded-xl placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-univ-indigo focus:border-transparent shadow-sm transition-all"
            />
          </div>
              ...
              {filteredStudents.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-5 py-12 text-center">
                    <GraduationCap className="h-8 w-8 mx-auto mb-3 opacity-20 text-slate-500" />
                    <p className="text-xs font-bold text-slate-500">No students found matching your criteria</p>
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={student.id} className="hover:bg-slate-50/50 transition-colors group">
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="h-9 w-9 rounded-lg bg-univ-indigo/10 flex items-center justify-center flex-shrink-0 text-univ-indigo font-bold text-sm">
                    ...
                    <td className="px-5 py-4">
                      <span className="inline-flex items-center px-2 py-1 text-[10px] font-bold uppercase tracking-wider bg-slate-100 text-slate-600 rounded">
                    ...
                    <td className="px-5 py-4">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-bold text-univ-indigo bg-indigo-50 hover:bg-univ-indigo hover:text-white rounded-lg transition-all opacity-0 group-hover:opacity-100 focus:opacity-100 cursor-pointer"
                      >
                        Evaluate
