...
const INITIAL_STUDENTS = [
  {
    ...
    documents: [
      { typeId: 'valid-id', fileName: 'maria_id.jpg', originalName: 'maria_id.jpg', uploadedAt: '2026-06-25T10:00:00', status: 'pending' },
      { typeId: 'form-137', fileName: 'maria_form137.pdf', originalName: 'maria_form137.pdf', uploadedAt: '2026-06-25T10:05:00', status: 'pending' },
      { typeId: 'report-card', fileName: 'maria_grades.pdf', originalName: 'maria_grades.pdf', uploadedAt: '2026-06-25T10:10:00', status: 'pending' },
  ...
  },
  {
    ...
    documents: [
      { typeId: 'valid-id', fileName: 'carlos_id.jpg', originalName: 'carlos_id.jpg', uploadedAt: '2026-06-20T09:00:00', status: 'approved' },
      ...
      { typeId: 'report-card', fileName: 'carlos_grades.pdf', originalName: 'carlos_grades.pdf', uploadedAt: '2026-06-20T09:10:00', status: 'approved' },
  ...
  },
  {
    ...
    documents: [
      { typeId: 'valid-id', fileName: 'ana_id.jpg', originalName: 'ana_id.jpg', uploadedAt: '2026-06-18T08:00:00', status: 'approved' },
      { typeId: 'form-137', fileName: 'ana_form137.pdf', originalName: 'ana_form137.pdf', uploadedAt: '2026-06-18T08:05:00', status: 'approved' },
      { typeId: 'report-card', fileName: 'ana_grades.pdf', originalName: 'ana_grades.pdf', uploadedAt: '2026-06-18T08:10:00', status: 'approved' },
  ...
  },
  {
    ...
    documents: [
      { typeId: 'valid-id', fileName: 'miguel_id.jpg', originalName: 'miguel_id.jpg', uploadedAt: '2026-06-15T11:00:00', status: 'approved' },
      ...
      { typeId: 'report-card', fileName: 'miguel_grades.pdf', originalName: 'miguel_grades.pdf', uploadedAt: '2026-06-15T11:10:00', status: 'approved' },
  ...
  },
  {
    ...
    status: 'enrolled',
    documents: [
      { typeId: 'valid-id', fileName: 'isabella_id.jpg', originalName: 'isabella_id.jpg', uploadedAt: '2026-06-10T14:00:00', status: 'approved' },
      ...
      { typeId: 'report-card', fileName: 'isabella_grades.pdf', originalName: 'isabella_grades.pdf', uploadedAt: '2026-06-10T14:10:00', status: 'approved' },
...
export async function seedStudents() {
  ...
  console.log('Students collection empty. Seeding initial applicant records...');
